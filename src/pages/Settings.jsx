            ...
            <div className="flex-1 space-y-6">
              ...
              <div>
                ...
                <div className="relative mt-2">
                  ...
                  <Input defaultValue="Amsterdam — Haarlemmerstraat" className="bg-[hsl(var(--background))] pl-10 px-3 py-1 text-base rounded-xl file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground flex w-full border-input shadow-sm transition-colors placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm border-0 h-12 focus-visible:ring-1 focus-visible:ring-[#796EB2]" />
                </div>
              </div>
