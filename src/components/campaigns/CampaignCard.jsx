...
export default function CampaignCard({ campaign, onTogglePause, onDelete }) {
  ...
  return (
    <div className="bg-white border border-[#EBEBF0] rounded-2xl p-5 hover:shadow-sm transition-all cursor-pointer flex items-center gap-3 justify-between" onClick={() => navigate(`/campaigns/${campaign.id}`)}>
