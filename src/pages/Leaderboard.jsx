  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-2xl shadow-[0_2px_8px_0_rgba(0,0,0,0.012)] overflow-hidden">
        {/* Table Header */}
        <div className="grid grid-cols-[60px_1fr_1fr_1fr_1fr_60px] gap-6 px-8 py-4 border-b border-[#F4F3FA]">
        ...
        {sorted.map((staff, i) => (
          <div
            key={staff.id}
            className={cn(
              "grid grid-cols-[60px_1fr_1fr_1fr_1fr_60px] gap-6 px-8 py-5 border-b border-[#EBEBF0] last:border-0 hover:bg-[#FAFAF9] transition-colors items-center",
              i === 0 && "bg-amber-50"
            )}
          >
            {/* Rank */}
