...
function WalletIcon({ size = 16, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <rect x="2" y="5" width="20" height="15" rx="3" fill="#796EB2" opacity="0.25"/>
      <rect x="2" y="5" width="20" height="15" rx="3" stroke="#796EB2" strokeWidth="1.8"/>
      <rect x="14" y="11" width="6" height="4" rx="1.5" fill="#796EB2"/>
      <line x1="2" y1="9" x2="22" y2="9" stroke="#796EB2" strokeWidth="1.5"/>
    </svg>
  );
}
