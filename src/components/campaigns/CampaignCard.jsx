...
export default function CampaignCard({ campaign, onTogglePause, onDelete }) {
  ...
  return (
    <div className="bg-white border border-[#EBEBF0] rounded-2xl p-5 hover:shadow-sm transition-all cursor-pointer grid grid-cols-[auto_1fr_200px_100px_auto] items-center gap-6" onClick={() => navigate(`/campaigns/${campaign.id}`)}>
