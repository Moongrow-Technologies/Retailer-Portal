...
export const CAMPAIGNS = [
  ...
  { id: 'c4', name: 'White Widow Weekend',  product_name: 'White Widow',   stores: ['De Groene Hoek — Zuid'],                             commission_rate: 2.50, budget: 200, spent: 200.00, units_sold: 80,  target_units: 80,  status: 'completed', start_date: '2026-04-05', end_date: '2026-04-20', duration_days: 15 },
