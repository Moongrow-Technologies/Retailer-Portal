  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="w-full bg-white rounded-xl border border-[#EBEBF0] overflow-hidden">
        {/* Table Header */}
        <div className="grid px-8 py-3 border-b border-[#EBEBF0] bg-[#F7F7F7]" style={{ gridTemplateColumns: '50px 200px 160px 160px 120px 80px' }}>
        ...
        {sorted.map((staff, i) => (
          <div key={staff.id}>
            <div className="grid px-8 py-6 items-center hover:bg-[#F5F3FC] transition-colors" style={{ gridTemplateColumns: '50px 200px 160px 160px 120px 80px' }}>
              {/* Rank */}
