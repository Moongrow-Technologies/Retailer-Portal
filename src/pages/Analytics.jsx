  ...
  return (
    <div>
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold text-[#0E0D1E]">Analytics</h1>
      ...
      <div className="bg-white rounded-2xl shadow-[0_2px_8px_0_rgba(0,0,0,0.012)] mb-6">
        ...
        <div className="grid grid-cols-4 border-b border-[#EBEBF0]">
          ...
          <div className="px-6 py-6 border-r border-[#EBEBF0]">
            ...
            <p className="text-xs text-emerald-600 font-medium mt-1.5">↑ 8% vs last period</p>
          </div>
          ...
          <div className="px-6 py-6 border-r border-[#EBEBF0]">
            ...
            <p className="text-xs text-emerald-600 font-medium mt-1.5">↑ 12% vs last period</p>
          </div>
