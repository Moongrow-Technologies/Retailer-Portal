...
export const CAMPAIGNS = [
  { id: 'c1', name: 'OG Kush Spring Push', product_name: 'OG Kush', product_image: 'https://images.unsplash.com/photo-1518685265887-f4629ea8d5f2?w=100&h=100&fit=crop', stores: ['De Groene Hoek — Centrum', 'De Groene Hoek — Oost'], commission_rate: 2.00, budget: 500, spent: 312.00, units_sold: 156, target_units: 250, status: 'active', start_date: '2026-03-15', end_date: '2026-04-30', duration_days: 46 },
  { id: 'c2', name: 'Blue Dream Blitz', product_name: 'Blue Dream', product_image: 'https://images.unsplash.com/photo-1518685265887-f4629ea8d5f2?w=100&h=100&fit=crop', stores: ['De Groene Hoek — Centrum'], commission_rate: 1.50, budget: 300, spent: 300.00, units_sold: 200, target_units: 200, status: 'completed', start_date: '2026-02-01', end_date: '2026-03-01', duration_days: 28 },
  { id: 'c3', name: 'Amnesia Haze Launch', product_name: 'Amnesia Haze', product_image: 'https://images.unsplash.com/photo-1518685265887-f4629ea8d5f2?w=100&h=100&fit=crop', stores: ['De Groene Hoek — Centrum', 'De Groene Hoek — Oost', 'De Groene Hoek — Zuid'], commission_rate: 2.50, budget: 750, spent: 185.00, units_sold: 74, target_units: 300, status: 'active', start_date: '2026-04-01', end_date: '2026-05-15', duration_days: 44 },
  { id: 'c4', name: 'White Widow Weekend', product_name: 'White Widow', product_image: 'https://images.unsplash.com/photo-1518685265887-f4629ea8d5f2?w=100&h=100&fit=crop', stores: ['De Groene Hoek — Zuid'], commission_rate: 1.75, budget: 200, spent: 200.00, units_sold: 114, target_units: 120, status: 'paused_budget', start_date: '2026-04-05', end_date: '2026-04-20', duration_days: 15 },
  { id: 'c5', name: 'Gorilla Glue Promo', product_name: 'Gorilla Glue', product_image: 'https://images.unsplash.com/photo-1518685265887-f4629ea8d5f2?w=100&h=100&fit=crop', stores: ['De Groene Hoek — Centrum'], commission_rate: 3.00, budget: 600, spent: 45.00, units_sold: 15, target_units: 200, status: 'paused_manual', start_date: '2026-04-10', end_date: '2026-05-10', duration_days: 30 },
];
