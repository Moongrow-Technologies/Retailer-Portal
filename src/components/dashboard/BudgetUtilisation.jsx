...
export default function BudgetUtilisation({ wallet }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#EBEBF0] shadow-[0_2px_8px_0_rgba(0,0,0,0.012)] p-6">
      <h3 className="text-lg font-semibold text-[#0c0b0c] mb-4">Budget utilisation</h3>
      
      <p className="text-4xl font-bold text-[#0c0b0c] mb-6">{percentage}%</p>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-[#F5F3FC] rounded-xl p-4">
          <p className="text-xs text-[#5b616e] font-medium mb-1">Spent this month</p>
          <p className="text-2xl font-bold text-[#0c0b0c]">€348</p>
        </div>
        <div className="bg-[#F5F3FC] rounded-xl p-4">
          <p className="text-xs text-[#5b616e] font-medium mb-1">Last top-up</p>
          <p className="text-2xl font-bold text-[#0c0b0c]">Apr 13</p>
